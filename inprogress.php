...
$sql = "SELECT * FROM complaints WHERE status='Accepted' || status='no'";
...
background: linear-gradient(to right, #93EDC7, #1CD8D2); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */">
            ...
            <div class="card" style="background-color: #c6e9e9;margin-bottom:20px;">
               ...
               <span style="margin-left:900px; font-size:small;"> <?php echo $row["created_at"]; ?></span></span>
                ...
                <div class="card-body">
                    ...
                    <!-- Arrow link -->
                    <a href="singleinprogress.php?id=<?php echo $row["id"]; ?>" class="arrow-link">
    ...
    <div class="card" style="background-color: #c6e9e9;margin-bottom:20px;">
    <div class="card-header" style="background:#e56b6f;color: #fff;">
   <span> <?php echo $row["id"]; ?>
   <span style="margin-left:900px; font-size:small;"> <?php echo $row["created_at"]; ?></span></span>
    </div>
    <div class="card-body">
        ...
        <p class="card-text"><?php echo $row["problem_title"]; ?></p>
        <!-- Arrow link -->
        <a href="singleproblempending.php?id=<?php echo $row["id"]; ?>" class="arrow-link">
            <i class="fa-solid fa-arrow-up-right-from-square"></i>
        </a>
    </div>
</div>
