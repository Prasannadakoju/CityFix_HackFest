...
background: linear-gradient(to right, #93EDC7, #1CD8D2); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */">
    ...
    <div class="container-fluid" style=" margin-top:160px;height:auto">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 justify-content-center">
                <p style="font-size:28px; font-weight:bold;color:#00827f;">Media</p>
    
                <!-- Video Section -->
    <div class="new-video">
        <?php
        // Assuming $complaint['video_link'] contains the video URL
        $videoLink = $complaint['video_link'];
        ?>
        <p id="video-link-paragraph" hidden><?php echo $videoLink; ?></p>
        
        <label for="video-input-file" id="video-area">
            <input type="file" accept="video/*" id="video-input-file" name="uploaded_video" hidden>
            
            <div id="video-view">
                <video controls style="width:430px; height:230px;">
    ...
    <div class="new-image">
        <?php
        // Assuming $complaint['image_link'] contains the image URL
        $imageLink = $complaint['image_link'];
        ?>
        <p id="image-link-paragraph" hidden><?php echo $imageLink; ?></p>
        
        <label for="image-input-file" id="image-area">
            <input type="file" accept="image/*" id="image-input-file" name="uploaded_image" hidden>
            
            <div id="img-view">
                <img src="<?php echo $imageLink; ?>" alt="Uploaded Image" style="width: 400px; height:300px;">
            </div>
        </label>
    </div>
    <div id="details-form" style="display: none; text-align: center;">
                    <h2>Enter Worker Details</h2>
                    <form action="workerinfo.php"method="POST">
     ...
     <!-- <div id="details-form" style="display: none; text-align: center;">
        Your worker details form here<?php echo $complaint['video_link']; ?>
    </div> -->
</div>

<script>
    // Retrieve the image and video links from PHP
    var imageLink = document.getElementById('image-link').textContent;
    var videoLink = document.getElementById('video-link').textContent;

    // Set the src attribute of the image element
    document.getElementById('image-display').src = imageLink;

    // Set the source attribute of the video element
    document.getElementById('video-source').src = videoLink;

    // // Show/hide image and video based on availability
    // if (imageLink) {
